...
public class addteacher extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        ptst.setString(5, "" + calcSalary(subject.getText()));
        ptst.executeUpdate();
    ...
    public static int calcSalary(String n){
        String[] substrings = n.split(",");
//        List<String> substringList = Arrays.asList(substrings);

        int salary = 0;

        for (String subject : substrings) {
            Teacher teacher = null;
            switch (subject){
                case "MI":
                    teacher = new TeacherDecorator(new MITeacher());
                    break;
                case "WT":
                    teacher = new TeacherDecorator(new WTTeacher());
                    break;
                case "DAA":
                    teacher = new TeacherDecorator(new DAATeacher());
                    break;
                case "CNS":
                    teacher = new TeacherDecorator(new CNSTeacher());
                    break;
            }
            
            salary += (teacher != null) ? teacher.getSalary() : 10000;
        }
